                        ...
                        <?php
                            switch($input['form_type']) {
                                case "text":
                                    ...
                                    echo form_input($input['form'], isset($service->$key) ? $service->$key : null );
                                    break;
                                case "textarea":
                                    echo '<div class="input-group col-xs-12">';
                                    echo form_textarea($input['form'], isset($service->$key) ? $service->$key: null );
                                    break;
                                case "password":
                                    echo '<div class="input-group col-xs-12">';
                                ...
                                case "select":
                                    echo '<div class="input-group col-xs-12">';
                                    echo form_dropdown($input['form'], $input['values'], isset($service->$key) ? $service->$key : null );
                                    break;
                                case "date":
